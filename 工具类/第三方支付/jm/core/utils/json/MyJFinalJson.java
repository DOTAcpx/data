...
public class MyJFinalJson extends Json {
	...
	static Map<Class, ObjectSerializer> serializer = new HashMap<>();

	public static ObjectSerializer put(Class<?> type, Object value) {
		return serializer.put(type, (ObjectSerializer) value);
	}
	...
	public static void setDefaultConvertDepth(int defaultConvertDepth) {
		...
		MyJFinalJson.defaultConvertDepth = defaultConvertDepth;
	}

	public MyJFinalJson setConvertDepth(int convertDepth) {
		if (convertDepth < 2) {
	...
	public MyJFinalJson setTimestampPattern(String timestampPattern) {
	...
	public static MyJFinalJson getJson() {
	...
	protected String toJson(Object value, int depth) {
		...
		ObjectSerializer os = serializer.get(value.getClass());

		if (os != null) {
			return os.serializer(value, this);
		}
