...
public class ReflectUtils {
	...
	/**
	 * 
	 * @date 2016年3月16日 上午11:34:05
	 * @author LGK
	 * @Description: 传入一个对象，对象为空或者对象里面的字段值都是null，返回true，否则false
	 * @param bean
	 * @return
	 *
	 */
	public static boolean checkObjIsNull(Object bean) {
		...
		try {
			...
			for (Field field : fields) {
				...
				if (field.getName().equals("serialVersionUID")) {// 序列化的这个属性不检查
					continue;
				}
