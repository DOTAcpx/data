...
public class SimplerEmailSender extends Authenticator implements IEmailSender {
	...
	private void init() {
		this.host = PropKit.get("host");// "smtp.qq.com";
		this.name = PropKit.get("name");// "198819880@qq.com";
		this.password =  PropKit.get("password");
		this.useSSL = PropKit.getBoolean("useSSL", false);
	}
